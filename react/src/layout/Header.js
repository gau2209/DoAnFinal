            ...
            {user === null ? <>
              ...
              <Link style={{ color: 'white', marginTop: '10px' }} className="nav-link " to="/order">Order</Link>:null}
                ...
                >
                  ...
                  <NavDropdown.Item>
                    <Link to={`user/${user.userId}`} className="nav-link" style={{ color: 'white', textAlign: 'center' }}> Lịch sử</Link>
                  </NavDropdown.Item>
                  ...
                  <Link to={`/YourStore/${user.userId}`} className="nav-link" style={{ color: 'white', textAlign: 'center' }}>Your Store </Link>
                  </NavDropdown.Item>

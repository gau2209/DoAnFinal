                        ...
                        <Col xs={14} md={4} className="mt-2" key={food.foodId}>
                            <Card style={{ width: '286px', height: '450px', alignItems: 'center' }}>
                                ...
                                <Card.Body style={{ textAlign: 'left' }}>
                                    ...
                                    <Link to={`/listfoods/${food.foodId}`} className="btn btn-info" style={{ marginRight: "5px" }} variant="primary">Xem chi tiết</Link>
                                </Card.Body>
                            </Card>
                        </Col>
                    ))
                        ...
                        return <Col xs={14} md={4} className="mt-2" key={food.foodId}>
                            <Card style={{ width: '286px', height: '600px', alignItems: 'center' }}>
                                ...
                                <Card.Body style={{ textAlign: 'left' }}>
                                    ...
                                    {stores.map((store) => {
                                        if (food.storeId.storeId === store.storeId) {
                                            return (
                                                <>
                                                    <div key={store.storeId} style={{ textAlign: 'center' }}>
                                                        <Card.Img style={{ width: '80px', height: '80px', borderRadius: '30%', objectFit: 'cover' }} src={store.imgfoodstore} alt={store.name} />
                                    ...
                                    <div style={{ textAlign: 'center' }}>
                                        <Button variant="success" onClick={() => order(food)}>Đặt món</Button>
                                        <Link to={`/listfoods/${food.foodId}`} className="btn btn-info" style={{ marginRight: "5px",marginLeft:'5px' }} variant="primary">Xem chi tiết</Link>
                                    </div>

        ...
        <>
            ...
            <Row>
                {records.map((s, storeId) => {
                    ...
                    return <Col key={storeId} xs={14} md={4} className="mt-2"><Card style={{ width: '286px', height: '564px', alignItems: 'center' }}>
                        ...
                        <Card.Body>
                            ...
                            {foods.map((f, foodId) => {
                                <strong>Các món ăn nổi bật</strong>
                                if (f.storeId.storeId === s.storeId) {
...
//                             <Button variant="success" style={{ marginLeft: '95px' }}> <Link to={url}>Xem</Link></Button>
//                         </Card.Body>
